...
*** intro-to-r-2
#+name:intro-to-r-2
#+HEADERS: :tangle intro-to-r-2.md :noweb tangle :padline no
#+BEGIN_SRC markdown
---
layout: default
...
*** intro-to-r-3
#+name:intro-to-r-3
#+HEADERS: :tangle intro-to-r-3.md :noweb tangle :padline no
#+BEGIN_SRC markdown
---
layout: default
...
- [intercepts_and_slopes_in_general_regression.R](./intercepts_and_slopes_in_general_regression.R)
